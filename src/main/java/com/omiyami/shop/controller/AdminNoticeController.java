...
import com.omiyami.shop.admin.AdminNoticeService;
...
public class AdminNoticeController {
    ...
    public String getNoticeList(Model model) {
        try {
            List<AdminNoticeVO> notices = noticeService.getNoticeList();
    ...
    public String noticeForm(Model model) {
        model.addAttribute("notice", new AdminNoticeVO());
        return "admin/post-notice-form";
    }
    
    // 공지사항 등록
    @PostMapping("/insertNotice")
    public String insertNotice(AdminNoticeVO notice, RedirectAttributes rttr) {
        try {
    ...
    public String modifyForm(@RequestParam("noticeId") Long noticeId, Model model) {
        try {
            AdminNoticeVO notice = noticeService.getNoticeById(noticeId);
            if (notice == null) {
    ...
    public String updateNotice(AdminNoticeVO notice, RedirectAttributes rttr) {
        try {
