...
<head>
  ...
  <link href="../${pageContext.request.contextPath}/resources/resources/css/fonts/fonts.css" rel="stylesheet" />
  ...
  <link href="../${pageContext.request.contextPath}/resources/css/style/admin.css" rel="stylesheet" />
  ...
  <div class="main-wrapper row">
    <div class="sidebar col-lg-2 px-0">
      <div class="d-flex justify-content-center my-5 logo">
        <a href="/main.html"> 
          <img class="logo-img" src="../resources/img/logo/logo.png" alt="logo" /></a>
      </div>
      ...
      <div class="product-container">
        ...
        <div class="product-info-container">
            ...
            <div class="thumbnail-wrapper">
              <div class="Thumbnail">
                <input class="form-control" type="file" id="Thumbnail" name="Thumbnail" accept="image/*"
                  style="display: none" />
                <label class="Thumbnail-before" id="Thumbnail-img" for="Thumbnail"
          ...
          <div class="card2">
            <div class="kr-600">
              <p>브랜드명</p>
              <input class="form-control" type="text" placeholder="브랜드명을 입력해주세요" />
            </div>
          </div>
          <div class="card2">
            <div class="kr-600">
          ...
          <div class="card2">
            <div class="kr-600">
              <p>이미지 등록</p>
              <input class="form-control" type="file" id="product-image" name="product-image" accept="image/*" />
            </div>
          </div>
          <div class="card2">
            <div class="kr-600">
              <p>제품 설명</p>
              <textarea class="form-control" id="product-description" placeholder="제품 설명을 입력해주세요" rows="20"
