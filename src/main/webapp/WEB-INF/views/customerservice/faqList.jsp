		...
		<div class="customerservice">
			<div class="row">
				...
				<div class="col-3 searchbox">
					<form action="/customerservice/faq/search" method="get" id="faq-searchform">
						<input class="search" type="text" name="keyword"/>
						<div class="search-icon">
							<a class="nav-link" href="javascript:void(0);"
								onclick="document.getElementById('faq-searchform').submit();">
			...
			<nav class="tabs d-flex" style="border-bottom: 2px solid var(--gray600)">
				<ul class="nav nav-fill w-80">
					...
					<li class="tabs-item nav-item"><span class="divider"></span></li>

					<li class="tabs-item nav-item">
						<a href="/customerservice/faqs" class="tablinks-active nav-link">
								<div>FAQ</div>
						</a>
					</li>
				...
				<table class="table">
					<tbody>
						<c:forEach var="faq" items="${faqList}">
							<tr onclick="openTab('content${faq.faq_id}'); return false;" style="cursor: pointer;">
								<th scope="row">[FAQ]</th>
								<td class="faq-title">
									<a href="javascript:void(0);" class="faq-link">${faq.title}</a>
								</td>
								<td class="faq-date">
									<fmt:formatDate value="${faq.write_date}" pattern="yyyy.MM.dd" />
								</td>
								<td class="rotate-img">
							...
							<tr class="content-wrapper" id="content${faq.faq_id}" style="display: none;">
								<th scope="row"></th>
								<td class="faq-content">${faq.content}</td>
								<td class="faq-date" colspan="2"></td>
							</tr>
						</c:forEach>
